...
export default class ViewerCore extends React.Component<ViewerProps, ViewerCoreState> {
  ...
  componentDidMount() {
    ...
    (this.viewCanvas as HTMLDivElement).addEventListener(
      'mousewheel',
  ...
  handleDownload = () => {
    ...
    if (activeImage.downloadUrl) {
      ...
      image.src = activeImage.downloadUrl;
    }
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          {this.props.noFooter || (
            <div className={`${this.prefixCls}-footer`} style={{ zIndex: zIndex + 5, width: '25%', maxWidth: 300 }}>
